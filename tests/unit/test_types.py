"""Tests for xainarratives.types — polymorphism, discriminators, validation."""
...
from xainarratives.types import Contribution, CounterfactualInstance, ExplanationRequest
