...
from xainarratives.providers.base import LLMResponse

_MISSING_SDK_MESSAGE = (
    "The 'anthropic' package is required. Install with: pip install \"xainarratives[anthropic]\""
)
...
class AnthropicProvider:
    ...
    Conforms structurally to ``xainarratives.providers.LLMProvider``.
    """
